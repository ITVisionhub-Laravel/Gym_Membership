   ...
   <div class="card w-50 mx-auto ">
     ...
     <div class="card-body">
        ...
        @csrf
            ...
            <div class="row">
                <x-forms.forminput name="price" placeholder="Enter Price" labelName="price" width="col-md-6" />
                <x-forms.forminput name="quantity" placeholder="Enter Quantity" labelName="quantity" width="col-md-6" />
            </div>
