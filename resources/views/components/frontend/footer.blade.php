                ...
                <div id="text-2" class="widget widget_text">
                    <h3 class="widgettitle">Opening Time</h3><br>			
                        <div class="textwidget">
                            <p class="hero"><i class="fa fa-calendar" style="font-size:15px"></i></i>&nbsp;Date & Time :{{ $logo->open_day ?? 'None'}} - {{ $logo->open_time ?? 'None'}}</p>
                            <p class="hero1"><i class="fa fa-clock-o" style="font-size:20px"></i>&nbsp;{{ $logo->close_day ?? 'None'}} Closed</p>
                        </div>
                </div>
            </div>
            <div class="col-sm-3 col-xs-12">
                <div id="text-3" class="widget widget_text">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-4">
                        ...
                        @if ($partner->image)
                        <img src="{{ asset("$partner->image") }}" width="70" height="70" alt="Partner">
                        @else
                        <p>none</p>
                        @endif
                       </div>
