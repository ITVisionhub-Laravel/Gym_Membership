...
<body>
    <x-frontend.navbar/>
    <div class="container" style="margin-top: 7.5rem !important;"> <!-- Added mt-4 for margin-top -->
        <div class="row">
            <div class="col-md-4">
                @if (empty($userDetailsData->image))
                    <img src="" alt="{{ $userDetailsData->name }}">
                @else
                    <img src="{{ asset('uploads/customer/' . $userDetailsData->image) }}" width="70" style="width:70%"
