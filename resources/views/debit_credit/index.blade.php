            ...
            @foreach($debitCredits as $debitCredit)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('debit-credit.edit', $debitCredit->id) }}" class="btn btn-info py-2">Edit</a>
                        <form action="{{ route('debit-credit.destroy', $debitCredit->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
