  ...
  <x-frontend.navbar :customer="$data['customerInfo']"/>
    ...
    <div class="choose-package">
      <div class="card-body row py-5 me-5">
          <div class="col-md-8">
              ...
              <div class="row">
                  ...
                  {{--   data-action = "choose_package"  --}}
                      <div type="button" class="col-4 col-md-3 mt-1 p-3 pkg_monthly pointer" wire:loading.attr="disabled" wire:click="choosePackage({{ $package->id }})">
         ...
         @if ($data['qrcode'])
         <div class="col-md-4 border rounded card">
            ...
            <div class="col-md-4 border rounded ">
                ...
                <form method="post" wire:submit.prevent="checkout(@if ($packageInfo){{ $packageInfo->id }} @endif)">
                    ...
                    <div class="row">
                        ...
                        {{--  @dd(->id)  --}}
                        <button class="btn btn-outline-secondary mt-5 mb-4 w-25 mx-auto" id="clear">Clear</button>
                        {{--  <div  wire:loading.attr="disabled" wire:click = "checkout(@if ($packageInfo){{ $packageInfo->id }}@endif)" >  --}}
                        <input type="submit" value="Checkout" class="btn pkg-btn mt-5 mb-4 w-50 mx-auto" id="pkg_register">
                        {{--  </div>  --}}
                        <br>
