    ...
    <div class="card w-50 mx-auto ">
        ...
        <div class="card-body">
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                {{-- <div class="row">
                    <x-forms.dropdownfield dropdownValues="categories" name="category_id" labelName=" Category"
                        width="col-md-6"></x-forms.dropdownfield>
                    <x-forms.dropdownfield dropdownValues="brands" name="brand_id" labelName=" Brand"
                        width="col-md-6"></x-forms.dropdownfield>
                </div> --}}
                ...
                <div class="row">
                    <x-forms.forminput name="small_description" type="textarea" placeholder="Enter small_description"
                        width="col-md-6" />
                    <x-forms.forminput name="description" type="textarea" placeholder="Enter description"
                        width="col-md-6" />
                </div>
                <div class="row">
